 ...
 *
 * Loading skeleton for the dashboard while project data is being fetched.
 * Provides visual placeholder that matches the dashboard layout.
 */
 ...
 * DashboardSkeleton component.
 *
 * Displays a loading placeholder that matches the dashboard layout.
 */
